...
use simplicial_topology::{simplicial_complex::{simplex::{Simplex, Facet}, simplicial_complex::SimplicialComplex, hypergraph::Hypergraph}, utils::utils::subvectors};
...
fn criterion_downward_closure_benchmark(c: &mut Criterion) {
    ...
    for i in 2..7 {
        hyperedges.extend(subvectors(&vertices, i));
    }
...
criterion_group!(benches, criterion_betti_benchmark, criterion_downward_closure_benchmark, criterion_upward_closure_benchmark);
